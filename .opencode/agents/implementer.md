...
7. When every task in your section is ticked, send the verifier a final `SECTION N COMPLETE` message, then end your turn. The foreman handles what happens next.
