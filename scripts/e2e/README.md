...
| 02 | jira    | DEMO ticket created, To Do, assigned; component set by the Atlassian MCP tool |
...
| 07 | register| repo registered with project/component/statusDefaults keys |
